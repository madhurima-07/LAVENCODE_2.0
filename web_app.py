...
# [State Management & Logic remains same]
...
if st.session_state.data is not None:
    ...
    # Red-based Chart
    fig = go.Figure(data=[go.Pie(labels=['Passed', 'Deductions'], values=[data['score'], 100-data['score']], 
                                 marker=dict(colors=['#ef4444', '#4a0e0e']), hole=.55)])
